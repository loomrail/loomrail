...
**Status:** alpha.3 published; procedure remains authoritative for the next release
**Updated:** 2026-09-01
...
The current pre-alpha version is `0.1.0-alpha.3`. It is published under the explicit `next` dist-tag. Future
