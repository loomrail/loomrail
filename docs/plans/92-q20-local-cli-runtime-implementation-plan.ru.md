...
8. Выполнить полный `pnpm verify`, release build/package checks и owner-approved local dogfood только на совместимых
   установленных runtimes. **Done for automated gates and accepted formal 3-WorkItem private Recurkit Epic through
   macOS Codex/Claude; Windows live evidence remains pending.**
