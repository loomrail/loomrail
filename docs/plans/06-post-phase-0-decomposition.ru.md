...
**A2 сделан, с одной оговоркой.** Живые адаптеры Codex и Claude Code заменили синтетический mock, но до E1
обслуживают только DISCOVERY, PLAN и REVIEW — стадии, которым достаточно собранного контекст-пака и текстового
ответа. IMPLEMENT и QA остаются на mock до E1: обоим CLI до тех пор негде писать, кроме пустого временного
каталога (спек [`11-a2-live-provider-adapters-spec.ru.md`](11-a2-live-provider-adapters-spec.ru.md) §4, D1).
