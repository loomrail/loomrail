...
**Статус:** E1.5, D1, D2, D3 и M7 завершены; следующий пункт — B5 + B1
**Нормативные входы:**
...
Текущий checkpoint: первый pre-alpha пакет и публичный лендинг опубликованы, M7 и трек D закрыты; следующий пункт —
