...
**Дата:** 2026-08-25; трек D добавлен 2026-08-27; checkpoint обновлён 2026-08-29

**Статус:** E1.5, D1 и D2 завершены; M7 ожидает первый опубликованный пакет, после него следующий пункт — D3
**Нормативные входы:**
...
Текущий checkpoint после D2: закрыть M7 первым опубликованным pre-alpha пакетом по
[`docs/RELEASE.md`](../RELEASE.md), затем провести D3 по обычному циклу design → plan → implementation. После D3
утверждённый порядок продолжается с B5 + B1.
