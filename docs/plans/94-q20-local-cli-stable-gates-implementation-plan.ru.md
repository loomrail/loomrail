...
**Статус:** complete; current stable index is 8/11
...
5. Проверить schema-v2/retired-key rejection, exact 8/11 summary, full `pnpm verify`, E2E и release package.
   **Done.**
6. Продвигать только gates с fixed-commit evidence; private dogfood и обе Windows local-CLI строки оставить `PENDING`.
   **Done.**
