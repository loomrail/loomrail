...
**Дата:** 2026-08-25. Декомпозиция принята; порядок утверждён владельцем.

Работа после Phase 0 разбита на три трека и один фундамент. Подробности, зависимости и обоснование порядка —
...
Утверждённый порядок: M7 → **A1** → A2 → E1 → B5+B1 → B3+B2 → C1 → C3 → C2 → B4.
