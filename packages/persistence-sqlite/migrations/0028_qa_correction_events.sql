-- Q2 automatic correction transitions are durable audit facts. Preserve every existing event and
-- sequence while widening the closed event type set for started and exhausted correction runs.
...
ALTER TABLE events RENAME TO events_v27;
