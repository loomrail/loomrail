-- A verification correction changes workflow truth and must be reconstructable from the audit
-- stream. Widen the closed Event vocabulary without changing any existing row or sequence.
...
ALTER TABLE events RENAME TO events_v43;
