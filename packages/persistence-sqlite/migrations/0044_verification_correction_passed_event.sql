-- Passing Project verification closes its correction authority and must remain visible after
-- restart. Widen the closed Event vocabulary without changing existing audit rows or sequences.
...
ALTER TABLE events RENAME TO events_v44;
...
CREATE TABLE events (
  ...
  type TEXT NOT NULL CHECK (
    type IN (
      ...
      'VERIFICATION_CORRECTION_PASSED',
