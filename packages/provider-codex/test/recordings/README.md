...
| `codex-0.154.0-alpha.6.2-success-macos-arm64.jsonl` | Captured from authenticated Codex CLI v0.154.0-alpha.6.2 on macOS arm64 with the adapter's exact read-only argv and FAST model `gpt-5.6-luna`. The five stdout lines are byte-exact; no replacement was needed.                                                                                                                                                                                                                                                                                                                                      |
| `codex-0.154.0-alpha.6.2-failure-macos-arm64.jsonl` | Captured from the same CLI/target with the same argv except for the deliberately invalid model `loomrail-invalid-model-01540a62`. It failed before useful inference. The five stdout lines are byte-exact; no replacement was needed. Workspace and MCP authority for this exact target are recorded separately by the full production workflow because Loomrail intentionally does not persist raw provider streams from product sessions.                                                                                                          |
